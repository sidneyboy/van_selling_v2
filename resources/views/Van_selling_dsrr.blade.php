            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <button class="btn btn-info btn-block" type="button" id="generate_principal">GENERATE PRINCIPAL</button>
                  <button class="btn btn-success btn-block" id="generate_daily_sales" style="display: none;" type="submit">GENERATE DAILY SALES REMITTANCE REPORT</button>
                </div>
              </div>
            </div>
          </form>
