<form id="bad_order_proceed_to_final_summary">
    @csrf
...
<script type="text/javascript">
      $("#bad_order_proceed_to_final_summary").on('submit',(function(e){
        e.preventDefault();
        $('.loading').show();
          $.ajax({
            url: "bad_order_proceed_to_final_summary",
            type: "POST",
            ...
            success: function(data){
              console.log(data);
               $('.loading').hide();
               $('#bad_order_proceed_to_final_summary_page').html(data);
            },
        });
    }));
</script>