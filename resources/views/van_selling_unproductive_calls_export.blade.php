    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title" style="font-weight: bold;">VAN SELLING PRODUCTIVE CALLS</h3>
            ...
            <div class="card-body">
                <form action="{{ route('van_selling_export_productive_calls_update_status') }}" method="post">
                    @csrf
                    <table class="table table-bordered table-sm table-striped" id="export_table">
                        <thead>
                            <tr>
                                <th>VAN SELLING PRODUCTIVE CALLS REPORT</th>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button class="btn btn-block btn-success" style="text-transform: uppercase;"
                                onclick="exportTableToCSV('{{ $agent_user->full_name . '-VAN_SELLING_PRODUCTIVE_CALLS-' . $date . '-' . $time }}.csv')">EXPORT
                                TABLE DATA</button>
                        </div>
                    </div>
                </form>
